...
def handle_text(message):
    ...
    if lang == "kz":
        if message.text == "📢 Жұмыс":
            ...
            bot.send_message(message.chat.id, "Ақылы жарнама үшін Kaspi немесе басқа әдіс арқылы төлеңіз. Байланыс: @admin")
        else:
        ...
        if message.text == "📢 Вакансии":
            ...
            bot.send_message(message.chat.id, "Для платного объявления свяжитесь через Kaspi или другой метод. Контакт: @admin")
        else:
